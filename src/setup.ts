...
const SHARED_DIRS: string[] = ['assets', 'layout', 'locales', 'sections', 'snippets'];
...
const settingsSchemaSrc = path.join(rootDir, 'config', 'settings_schema.json');
...
STORES.forEach((store) => {
  ...
  const settingsDataSrc = path.join(rootDir, 'config', 'settings_data.json');
